...
1. 10/07/2024 [Fabián Villena](https://villena.cl/) presentó su seminario titulado: Despliegue local de grandes modelos de lenguaje de pesos libres y su consumo ([slides](slides/llm_deployment_and_consumption_tutorial.pdf))([video](https://drive.google.com/file/d/11H71RnhCNQMMWSeuzs-SwmZQQVqM4yuE/view?usp=sharing)).
